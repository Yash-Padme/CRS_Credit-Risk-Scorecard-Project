...
**Author:** Yash Padme
ABV-Indian Institute of Information Technology and Management (IIITM) Gwalior, Madhya Pradesh
...
![EDA](notebooks/fig1_eda.png)

## WoE / Information Value Analysis

![WoE](notebooks/fig2_woe.png)

## Model Validation

![Model](notebooks/fig3_model_performance.png)

## SHAP Explainability

![SHAP](notebooks/fig4_shap.png)

## Probability Calibration

![Calibration](notebooks/fig5_calibration.png)

## IFRS-9 Expected Credit Loss

![ECL](notebooks/fig6_ecl.png)
...
Credit_Risk_Scorecard_yash.ipynb
...
git clone https://github.com/Yash-Padme/CRS_Credit-Risk-Scorecard-Project.git
